...
RUN cd /tmp; git clone --recursive --depth 1 --branch N.2.7.4 https://github.com/ArweaveTeam/arweave.git
RUN cd /tmp/arweave; ./rebar3 as prod tar
RUN cd /app; tar -zxvf /tmp/arweave/_build/prod/rel/arweave/arweave-2.7.4.tar.gz
